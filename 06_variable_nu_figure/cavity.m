...
%CAVITY return position, first and second derivatives of Charlie's cavity 
% object domain with the parameterization 
%
% Syntax: [r,d,d2] = starfish(t,j)
%
% Input:
%   t - array of point (in [0,2pi])
%
% Optional input:
%   j - real number between 0 and 11
%
% Output:
...
%
% Examples:
%   [r,d,d2] = cavity(t); % get default settings 
%   [r,d,d2] = cavity(t,j); % change some settings
