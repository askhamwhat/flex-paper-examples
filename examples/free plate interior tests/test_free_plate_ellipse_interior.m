...
[~, ~, hess, third, ~] = chnk.flex2d.helmdiffgreen(zk, [3;2], chnkr.r);
[~, ~, hessK, thirdK, ~] = chnk.flex2d.helmdiffgreen(zk*(1i), [3;2], chnkr.r);
...
[val,~] = chnk.flex2d.green(zk,[3;2],targets(:,in));        % Hankel part

zkimag = (1i)*zk;
[valK,~] = chnk.flex2d.green(zkimag,[3;2], targets(:,in));    % modified bessel K part
...
title("Absolute error on an ellipse", 'FontSize',16)
