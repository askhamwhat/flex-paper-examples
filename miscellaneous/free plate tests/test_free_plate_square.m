...
cparams = [];
cparams.widths = 0.05*ones(size(verts, 2), 1);                   % do corner rounding.

cparmas.eps = 1e-6;


opts = [];
opts.maxchunklen = 4./zk;
...
title("Absolute error (free plate kernel on a square (corner rounding 0.005)", 'FontSize',16)
