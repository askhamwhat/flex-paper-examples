...
[~, ~, hessK, thirdK, ~] = chnk.flex2d.helmdiffgreen(zkimag, [0;0], chnkr.r);
...
[val,~] = chnk.flex2d.helmdiffgreen(zk,[0;0],targets(:,out));        % Hankel part

zkimag = (1i)*zk;
[valK,~] = chnk.flex2d.helmdiffgreen(zkimag, [0;0], targets(:,out));    % modified bessel K part
