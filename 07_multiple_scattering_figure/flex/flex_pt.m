function [data] = flex_pt(zk,coefs,srcs,targs)

    np = size(targs.r(:,:),2);
    [~, ~, hess, third, ~] = chnk.flex2d.helmdiffgreen(zk, srcs, targs.r);
    [~, ~, hessK, thirdK, ~] = chnk.flex2d.helmdiffgreen(zk*(1i), srcs, targs.r);
